...
tinymce.init({
    selector:'textarea#samwise-editor-body',

    setup: function (ed) {
        ed.on('init', function( e ) {
var	    converter = new showdown.Converter(),
		    text      = $('#gollum-editor-body').val(),
...
$('#gollum-editor-submit').on('click', function ( e ) {
  html = tinymce.get('samwise-editor-body').getContent();
  text = toMarkdown(html);
  $('#gollum-editor-body').val(text);
});
